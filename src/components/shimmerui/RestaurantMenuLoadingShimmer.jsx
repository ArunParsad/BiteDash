...
const RestaurantMenuLoadingShimmer = () => {
  ...
  return (
    <Container>
      <div className='grid grid-cols-12 mt-5 gap-x-2 h-[65vh] mx-5'>
        <div className='col-span-3 bg-white shadow-md p-4 rounded-md space-y-3 h-[65vh] overflow-hide scrollbar-hide'>
          <Skeleton count={20} />
        </div>
